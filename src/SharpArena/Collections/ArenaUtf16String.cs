...
public readonly unsafe struct ArenaUtf16String : IEquatable<ArenaUtf16String>
{
    ...
    public void Verify(ArenaAllocator arena)
    {
        ...
        UnsafeHelpers.CheckAliveThrowIfNot(arena, _generation, nameof(ArenaUtf16String));
    }
    ...
    /// <returns>An <see cref="ArenaUtf16String"/> referencing the cloned characters.</returns>
    ...
    public override bool Equals(object? obj) =>
        obj is ArenaUtf16String s && Equals(s);
    ...
    /// <summary>
    /// Creates a new <see cref="ArenaUtf16String"/> that references a subrange of the current buffer.
    /// </summary>
    ...
    /// </exception>
    public ArenaUtf16String Slice(int start, int length)
    {
        if (start < 0)
        {
        ...
        return new ArenaUtf16String(_ptr + start, length, _generation);
    }
    ...
    /// <returns>A new <see cref="ArenaUtf16String"/> containing the concatenated characters.</returns>
    public static ArenaUtf16String Concatenate(ArenaUtf16String left, ArenaUtf16String right, ArenaAllocator arena)
    {
